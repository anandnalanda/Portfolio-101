/**
 * chibi.tsx - OFM Jobs' OWN copy of the pen-doodle cast (Kanban + OFM Jobs
 * Tests illustrations). Deliberately independent of the Staple case studies:
 * OFM and Staple are kept as separate things, so neither imports from the
 * other. Same visual language, OFM emerald ink.
 *
...
export const INK = "#123A2B"; // OFM dark emerald ink (Staple's copy uses teal)
